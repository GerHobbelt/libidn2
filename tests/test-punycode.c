...
static const struct punycode punycode[] = {
    ...
    0x061F}, "egbpdaj6bu4bxfgehfvwxn", IDN2_OK},
  {
   "(B) Chinese (simplified)", 9,
   {
    ...
    0x6587}, "ihqwcrb4cv8a8dqg056pqjye", IDN2_OK},
  {
   "(C) Chinese (traditional)", 9,
   {
    0x4ED6, 0x5011, 0x7232, 0x4EC0, 0x9EBD, 0x4E0D, 0x8AAA, 0x4E2D,
    0x6587}, "ihqwctvzc91f659drss3x8bo0yb", IDN2_OK},
  {
   ...
   "Proprostnemluvesky-uyb24dma41a", IDN2_OK},
  {
   "(E) Hebrew:", 22,
   {
   ...
   "4dbcagdahymbxekheh6e0a7fei0b", IDN2_OK},
  {
   ...
   "i1baa7eci9glrd9b2ae1bj0hfcgg6iyaf8o0a1dig0cd", IDN2_OK},
  {
   "(G) Japanese (kanji and hiragana):", 18,
   {
    ...
    0x306E, 0x304B},
   "n8jok5ay5dzabd5bym9f0cm5685rrjetr6pdxa", IDN2_OK},
  {
   ...
   IDN2_OK},
  {
   ...
   "b1abfaaepdrnnbgefbadotcwatmq2g4l", IDN2_OK},
  {
   ...
   "PorqunopuedensimplementehablarenEspaol-fmd56a", IDN2_OK},
  {
   "(K) Vietnamese:", 31,
   {
   ...
   "TisaohkhngthchnitingVit-kjcr8268qyxafd2f1b9g", IDN2_OK},
  {
   "(L) 3<nen>B<gumi><kinpachi><sensei>", 8,
   {
    0x0033, 0x5E74, 0x0042, 0x7D44, 0x91D1, 0x516B, 0x5148, 0x751F},
   "3B-ww4c5e180e575a65lsy2b", IDN2_OK},
  {
   ...
   "-with-SUPER-MONKEYS-pc58ag80a8qai00g7n9n", IDN2_OK},
  {
   "(N) Hello-Another-Way-<sorezore><no><basho>", 25,
   {
    ...
    0x6240},
   "Hello-Another-Way--fc4qua05auwb3674vfr0b", IDN2_OK},
  {
   "(O) <hitotsu><yane><no><shita>2", 8,
   {
    0x3072, 0x3068, 0x3064, 0x5C4B, 0x6839, 0x306E, 0x4E0B, 0x0032},
   "2-u9tlzr9756bt3uc0v", IDN2_OK},
  {
   ...
   "MajiKoi5-783gue6qz075azm5e", IDN2_OK},
  {
   "(Q) <pafii>de<runba>", 9,
   {
    0x30D1, 0x30D5, 0x30A3, 0x30FC, 0x0064, 0x0065, 0x30EB, 0x30F3, 0x30D0},
   "de-jg4avhby1noc0d", IDN2_OK},
  {
   "(R) <sono><supiido><de>", 7,
   {
